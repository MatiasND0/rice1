...
module.exports.register = (req, res) => {
    const { username, password, role, phoneNumber, nombre, apellido, cod_materias, dni } = req.body;

    // Validaciones simples
    if (!username || !password || !role || !phoneNumber || !nombre || !apellido || !cod_materias || !dni) {
