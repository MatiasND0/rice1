            ...
            sortedData.map((reserva) => (
              <tr key={reserva.id_reserva}>
                ...
                <td className="border px-4 py-2">
                  ...
                  <button className="text-green-600 hover:text-green-800" onClick={() => handleRetiroConfirm(reserva.id_reserva)}>
                    Retiro
                  </button>
