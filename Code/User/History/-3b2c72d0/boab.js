          ...
          sortedData.map((reserva) => (
            <tr key={reserva.id_reserva}>
              ...
              <td className="border px-4 py-2">
                ...
                <button className="text-green-600 hover:text-green-800" onClick={() => handleDeleteConfirm(reserva.id_reserva)}>
                  Retiro
                </button>
                <button className="text-blue-600 hover:text-blue-800" onClick={() => handleDeleteConfirm(reserva.id_reserva)}>
                  Devolvio
                </button>
              </td>
            </tr>
