...
import ReservaProyector from './components/ReservaProyector'; // Importa el nuevo componente
    ...
    <main className='App'>
      <Router>
        ...
        <Routes>
          ...
          <Route path="/reserva-proyector" element={<ReservaProyector />} /> {/* Agrega la nueva ruta */}
        </Routes>
      </Router>
    </main>
  );
