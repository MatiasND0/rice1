    ...
    const handleSubmit = async (e) => {
        ...
        if (semana && proyector && hora && cod_materia) { // Verificar que materia no esté vacío
            ...
            const reservaData = {
                ...
                cod_materia, // Incluir el campo materia en los datos de la reserva
            };
            ...
            try {
                ...
                if (response.ok) {
                    ...
                    setProyector("");
                    setHora("");
                    setMateria(""); // Limpiar el campo materia
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <div className="space-y-2">
                        ...
                        >
                            ...
                            {proyectoresDisponibles.map((proyector) => (
                                <option key={proyector.cod_rec} value={proyector.nro_inv}>
                                    {proyector.cod_rec}
                                </option>
                            ))}
                        </select>
                ...
                {proyector && (
                    <div className="space-y-2">
                        ...
                        >
                            <option value="">Selecciona un proyector</option>
                            {parsedToken.materias.map((materia) => (
