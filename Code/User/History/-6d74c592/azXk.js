...
function obtenerMateriasPorUsuario(id_usuario) {
    return new Promise((resolve, reject) => {
        const sql = 'SELECT materias.cod_materia, materias.materia FROM usuario_materia JOIN materias ON usuario_materia.materias_cod_materia = materias.cod_materia WHERE usuarios_id_usuario = ?';
